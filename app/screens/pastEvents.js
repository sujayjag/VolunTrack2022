...
const pastEvents = ({ navigation }) => {
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.createdButton} onPress={() => navigation.navigate("createdEvents")}>
                <Text style={styles.createdText}>Created Events</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.joinedButton} onPress={() => navigation.navigate("joinedEvents")}>
